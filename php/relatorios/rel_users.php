...
<body>
  <div class="box">
    <div class="data-box" style="margin: 0; align-items: center; justify-content: space-between;">
      <h1 style=>Relatório de Usuários</h1>
    ...
    <div class="data-content">
      ...
      <?php
          ...
          $postagem = $con->query("SELECT * FROM `usuarios` ORDER BY idUsuarios DESC LIMIT $limite OFFSET $offset");   
      ...
      <div class="data-box">
        <section class="data-row">
          <b class="data-header">Usuário</b>
          <b class="data-header">Contato</b>
        </section>

        <section class="data-row" id="data">
          <p class="data-item"><?= $info['Usuario'] ?></p>
          <p class="data-item"><?= $info['Contato'] ?></p>
        </section>
      </div>
      <div class="data-box">
        <a class="data-edit" href="upd_users.php?id=<?=$info['idUsuarios']?>"><i class="fas fa-pencil-alt"></i></a>
        <a class="data-delete" href="#" onclick="startModal('modal-delete'); userId = <?=$info['idUsuarios']?>;"><i class="fas fa-trash"></i></a>
      </div>
